...
export default function HeroHeader() {
  ...
  return (
    <section className="relative bg-brand-white text-brand-black px-6 py-20 md:py-28">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-7">
            ...
            >
              ...
              <Link
                ...
                className="inline-flex justify-center items-center rounded-md border-2 border-brand-black bg-transparent text-brand-black px-6 py-3 font-semibold tracking-wide hover:bg-brand-black hover:text-brand-white transition duration-300 w-full sm:w-auto min-w-[200px]"
              >
                See pricing
              </Link>
            </motion.div>
            ...
            <motion.ul
              ...
              className="mt-5 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-brand-black/70"
            >
              {[
                "Month-to-month",
          ...
          >
            <div className="rounded-2xl h-130 overflow-hidden">
