...
export default function Home() {
  return (
    <main className="text-brand-black">
          ...
          <nav className="flex gap-6">
            {[
              ...
              <a
                key={i}
                href={`#${target}`}
                className="relative text-md font-light font-sans text-brand-black pb-1 
      ...
      {/* Hero Section */}
      <section
        className="relative py-40 px-6 text-center text-brand-white overflow-hidden"
      >
        {/* Background Image */}
      ...
      <section id="how" className="relative bg-brand-white text-center pt-12 py-32 pb-40 px-6 overflow-hidden">
      ...
      {/* Pricing */}
      <section id="pricing" className="bg-brand-black py-20 px-6 border-y border-brand-black">
        <motion.h2
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4 }}
          viewport={{ once: true }}
          className="font-sans text-4xl font-semibold text-center mb-4 text-brand-white"
        >
          Pricing Plans
        </motion.h2>
        ...
        <motion.p
          ...
          transition={{ delay: 0.2 }}
          viewport={{ once: true }}
          className="font-light text-lg max-w-2xl mx-auto mb-16 text-brand-white text-center relative"
        >
          Our streamlined process ensures your project moves from concept to completion efficiently and effectively.
        </motion.p>
          ...
          {[
            ...
            <motion.div
              ...
              className={`rounded-md p-6 text-center shadow-md ${
                plan.highlighted ? "bg-brand-sand" : "bg-white"
              } text-brand-black`}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: i * 0.15 }}
